...
;(function () {
  ...
  var css_248z$1 =
    '.__copy-button{align-items:center;background:#4c98f7;border-radius:3px;color:#fff;cursor:pointer;display:flex;font-size:13px;height:30px;justify-content:center;opacity:0;position:absolute;transition:opacity .3s;width:60px;z-index:-1000}'

  var css_248z =
    '#select-tooltip,#sfModal,.modal-backdrop,div[id^=reader-helper]{display:none!important}.modal-open{overflow:auto!important}._sf_adjust_body{padding-right:0!important}'
  ...
  var utils = {
    ...
    enableOnKeyDown: (selector) => {
      const dom = document.querySelector(selector)
      dom &&
        dom.addEventListener(KEY_DOWN, (e) => {
